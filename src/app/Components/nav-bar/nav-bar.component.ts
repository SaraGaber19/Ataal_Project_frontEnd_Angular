...
export class NavBarComponent implements OnInit {
  ...
  ///////////hossam////////
  Technical: any;
  notificationNumber_Technical: any = 0;
  AllSections: any;
  AllProblems: any;
  selected: any;
  searchText: string = '';
    ...
    this.Auth.UserId.subscribe(() => {
      if (this.Auth.UserId.getValue() != null) {
        if (this.Auth.userRole.getValue() == 'Customer') {
          ...
          this.myservice.getTechnicalNotification(this.Techn).subscribe({
            next: (data) => {
              this.notificationNumber_Technical = data;
              console.log("nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn")
              console.log(data)
            },
          });
  ...
  FilterProblemsBySection(sectionId: number) {
    this.browseAllJobsService
      .GetAllProblemsInfoBySectionId(sectionId, this.Techn)
      .subscribe({
        next: (data: any) => {
          this.globalVar.getProblems().subscribe({
            next: (FilterdProblems) => {
  ...
  onSearchEnterClick(event: any) {
    ...
    this.searchService
      .GetResultOfSearch(event.target.value, this.TechnicalId)
      .subscribe({
        next: (data: any) => {
          //this.globalVar.AllProblemsFromService = data;
          //this.AllProblems = data;
  ...
  setNotificationTechnical() {
    this.myservice.setNotificationTechnical(this.Techn).subscribe({
      next: (data) => {
        this.notificationNumber_Technical = 0;
        console.log(data)
      },
    });
